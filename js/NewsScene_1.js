...
const journal2 = document.querySelector('.journal2');
...
function flashing2() {
    ...
    profile.classList.add('animate__headShake');
    setTimeout(function () {

        profile.classList.remove('animate__headShake');
    }, 1500);
}
...
function flashing3() {
    ...
    journal.classList.add('animate__headShake');

    setTimeout(function () {

        journal.classList.remove('animate__headShake');
...
function factcheck_intro_3() {
    ...
    journal.classList.remove('animate__animated');
    container.style.opacity = "0.2";
...
//사용자 동작이벤트(공유하기 클릭해보세요)에 따라 '팩트체크' 모달 활성화
