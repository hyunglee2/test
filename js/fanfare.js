...
const okBtn5 = document.getElementById("okBtn5");
...
//console.log(content5.offsetHeight);
// console.log(modal5.offsetWidth);
// canvas settings
var viewWidth = 300,
    viewHeight = 300,
...
function createLoader() {
    loader = new Loader(viewWidth * 0.3, viewHeight * 0.3);
}
